...
This module provides training and evaluation for Decision Tree classifier
...
def train_and_evaluate(X_train, y_train, X_test, y_test):
    """
    Train and evaluate Decision Tree model with GridSearchCV tuning.
    ...
    """
    print("\n" + "=" * 70)
    print("TRAINING DECISION TREE CLASSIFIER (GridSearchCV)")
    print("=" * 70)
