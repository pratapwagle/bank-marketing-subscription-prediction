...
This module provides training and evaluation for XGBoost ensemble classifier
...
def train_and_evaluate(X_train, y_train, X_test, y_test):
    """
    Train and evaluate XGBoost model with GridSearchCV tuning.
    ...
    print("\n" + "=" * 70)
    print("TRAINING XGBOOST CLASSIFIER (GridSearchCV)")
    print("=" * 70)
    ...
    imbalance_ratio = round(neg_count / pos_count, 2) if pos_count > 0 else 1.0
