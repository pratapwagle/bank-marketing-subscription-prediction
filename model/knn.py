"""
K-Nearest Neighbors Classifier Training and Evaluation.

This module provides training and evaluation for KNN classifier
...
def train_and_evaluate(X_train, y_train, X_test, y_test):
    """
    Train and evaluate K-Nearest Neighbors model with GridSearchCV tuning.
    ...
    """
    print("\n" + "=" * 70)
    print("TRAINING K-NEAREST NEIGHBORS CLASSIFIER (GridSearchCV)")
    print("=" * 70)
